...
python hic_allelic_counts.py ${out_dir}/all_${s}.phase_allele1_counts.txt ${out_dir}/all_${s}.phase_allele2_counts.txt ${out_dir}/all_${phase1}_${s}_counts.txt ${out_dir}/all_${phase2}_${s}_counts.txt /home/leeh7/iQTL/Yang_HiC/AlleliC/new_liftover/${phase1}_union.hic.bedpe_0407 /home/leeh7/iQTL/Yang_HiC/AlleliC/new_liftover/${phase2}_union.hic.bedpe_0407 /home/leeh7/iQTL/Yang_HiC/AlleliC/new_liftover/mouse_union.hic.bedpe_0407 ${out_dir}/${phase1}x${phase2}_${s}_allelic_total_counts.txt
